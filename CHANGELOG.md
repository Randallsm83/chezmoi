...
### Removed
- **pam integration**: removed the Personal Agent Multiplexer package mapping, managed config, service, secret env file, shell wrappers/completions, navigation helpers, and editor MCP pointers. opencode now imports standalone Claude MCP entries directly and re-enables bundled MCPs such as context7.
